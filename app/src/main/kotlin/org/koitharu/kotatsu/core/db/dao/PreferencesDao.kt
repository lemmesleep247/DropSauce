...
abstract class PreferencesDao {
	...
	@Query("SELECT * FROM preferences WHERE title_override IS NOT NULL OR cover_override IS NOT NULL OR content_rating_override IS NOT NULL OR merge_scanlators = 1")
